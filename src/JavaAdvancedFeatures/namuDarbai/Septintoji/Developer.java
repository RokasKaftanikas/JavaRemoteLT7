...
public class Developer extends Person{
    ...
    private boolean isDeveloperaProgrammer;
    
    public Developer(String development, double yearsOfExperience, boolean isDeveloperaProgrammer) {
        super(development, yearsOfExperience);
        this.isDeveloperaProgrammer = isDeveloperaProgrammer;
    }


    @Override
    public String developerISright() {
        return null;
    }
